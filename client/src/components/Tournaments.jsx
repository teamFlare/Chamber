...
class Tournaments extends React.Component {
  ...
  render() {
    return (
      <div>
      <h1>Tournaments</h1>
      <button onClick={() => this.setState({round1boolean: true, round2boolean: false, finalsboolean: false, createboolean: false, uploadboolean: false})}>First Round</button>
      <button onClick={() => this.setState({round1boolean: false, round2boolean: true, finalsboolean: false, createboolean: false, uploadboolean: false})}>Second Round</button>
      <button onClick={() => this.setState({round1boolean: false, round2boolean: false, finalsboolean: true, createboolean: false, uploadboolean: false})}>Finals</button>
      <button onClick={() => this.setState({round1boolean: false, round2boolean: false, finalsboolean: false, createboolean: false, uploadboolean: true})}>Upload</button>
      {this.state.profileunlock ? <button onClick={() => this.setState({createboolean: true, round1boolean: false, round2boolean: false, finalsboolean: false, uploadboolean: false})}>Create Tournament</button>: null}
