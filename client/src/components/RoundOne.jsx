  ...
  render() {
    ...
    return (
      <div>
          ...
          <div className = "songTitle">Votes: {this.state.round1matchup1.profile1count}</div>
          <button className=" btn comBut btn-danger" onClick={() => this.voteSubmission(1, this.state.round1matchup1)}>Like</button>
          {this.state.profileunlock ?<button className="btn comBut btn-danger" onClick={() => this.insertRound2(1, this.state.round1matchup1)}>Move to round 2</button>: null}
          ...
          <button className=" btn comBut btn-danger" onClick={() => this.voteSubmission(2, this.state.round1matchup1)}>Like</button>
          {this.state.profileunlock ?<button className="btn comBut btn-danger" onClick={() => this.insertRound2(2, this.state.round1matchup1)}>Move to round 2</button>: null}
